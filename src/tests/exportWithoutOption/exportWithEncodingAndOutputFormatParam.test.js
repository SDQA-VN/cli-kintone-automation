...
describe('Export without --export option: Export data with encoding and output format (-e) (-o)', () => {
    ...
    test('Case 323: Guest space - Verify that data can be exported in csv format with sjis', async () => {
    ...
    test('Case 324: Verify that data can be exported in json format with euc-jp', async () => {
        const fieldArg = `-c ${fieldNames}`;
